...
<head>
    ...
    <style>
        ...
        #ar-button-container {
            ...
            z-index: 1000;
            /* Estilos del botón AR (ARButton los aplica, pero podemos dar un fallback) */
        }
        ...
        #info {
         ...
         /* Estilo para mensaje de error si AR no es soportado */
         .ar-error-message {
             position: absolute;
             top: 50%;
             left: 50%;
...
<body>
    ...
    <div id="info">Busca una superficie y toca la pantalla para colocar el cubo.</div>

    <!-- Script principal que incluye ARButton y la lógica de la aplicación -->
    <script type="module">
                console.log('ImportMap cargado');
