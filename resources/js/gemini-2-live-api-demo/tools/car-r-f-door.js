 ...
 */
export class openCarRightFrontTool {
    /**
     * Returns the tool declaration for Gemini
     */
    getDeclaration() {
        return {
            name: "openCarRightFront",
            description: "Opens the car right Front door in AR mode",
        };
    }
    ...
    execute(args) {
        ...
        const event = new CustomEvent('open_r_f_door');
        document.dispatchEvent(event);
        
        console.log('Car trunk event dispatched by Gemini');
        return "I've opened the car right Front door for you. Take a look in AR mode!";
    }
}