 ...
 */
export class openCarLeftBackTool {
    /**
     * Returns the tool declaration for Gemini
     */
    getDeclaration() {
        return {
            name: "openCarLeftBack",
            description: "Opens the car Left back door in AR mode",
        };
    }
    ...
    execute(args) {
        ...
        const event = new CustomEvent('open_l_b_door');
        document.dispatchEvent(event);
        
        console.log('Car trunk event dispatched by Gemini');
        return "I've opened the car Left back door for you. Take a look in AR mode!";
    }
}