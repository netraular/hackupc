 ...
 */
export class closeCarLeftBackTool {
    /**
     * Returns the tool declaration for Gemini
     */
    getDeclaration() {
        return {
            name: "closeCarLeftBack",
            description: "Close the car Left back door in AR mode",
        };
    }
    ...
    execute(args) {
        ...
        const event = new CustomEvent('close_l_b_door');
        document.dispatchEvent(event);
        
        console.log('Car trunk event dispatched by Gemini');
        return "I've closed the car Left back door for you. Take a look in AR mode!";
    }
}